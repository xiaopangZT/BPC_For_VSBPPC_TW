...
public class DoubleValue_Item implements Comparable<Item> {
    public int id;
    public int index;
    ...
    public DoubleValue_Item() {
    }

    public DoubleValue_Item(int id, int index, int startTime, int endTime, int volume, double dualVal, double unitVal) {
        this.id = id;
        this.index = index;
    ...
    public DoubleValue_Item(int id, int index, int volume) {
        this.id = id;
        this.index = index;
        this.volume = volume;
    }

    public DoubleValue_Item(int id, int index, int volume, int startTime, int endTime) {
        this.id = id;
        this.index = index;
        this.volume = volume;
        this.startTime = startTime;
